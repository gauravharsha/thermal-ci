...
from tfdcisd.fixrefodefuncs import EvolutionFixRef, eval_energy, eval_number
...
def main():
    ...
    evol = EvolutionFixRef(inp_file=input_file, alpha_step=0.05)
    ...
    output_fn = output_fn.replace('_data.h5', '_tfd_cisd_fixref.h5')
