...
# Overlap Operators
ovlp_op = dr2.memoize(lambda: dr2.simplify( Tvec ), 'ovlp_op.pickle')
...
with open('FixEnAndOvlp.f90','w') as fp:
    print(code, file=fp)
...
"""-------------------------------------------------------------------------"""
with dr.report('en_and_ovlp_fix_pt.html','Thermal Perturbation Theory') as rep:
